...
contract Groth16Verifier {
    ...
    uint256 constant deltax1 = 14973201058635675931414833596926431651275639229073428693190865031601453269946;
    uint256 constant deltax2 = 5566593866606042134048643781270232435528918189445914651856560192197268587060;
    uint256 constant deltay1 = 11487220290961074805704405739090122844688536259297619820196796788201487666274;
    uint256 constant deltay2 = 15382131724333427862699105908632264703107629751313128760829948894153233875148;

    
    uint256 constant IC0x = 2755912451444064375563373857459204225488217505716195502039633992209059830014;
    uint256 constant IC0y = 21557221135575593040773554838242577643100331611320233754861565018045569573772;
    ...
    function verifyProof(uint[2] calldata _pA, uint[2][2] calldata _pB, uint[2] calldata _pC, uint[8] calldata _pubSignals) public view returns (bool isValid) {
        assembly {
